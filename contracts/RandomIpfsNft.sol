...
error RandomIpfsNft__RangeOitOfBounds();
...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    event NftMinted(Breed dogBreeder, address minter);
    ...
    ) VRFConsumerBaseV2(vrfCoordinatorV2) ERC721("Random Ipfs NFT", "IPNFT") {
    ...
    function getBreedFromModdedRng(
        ...
        revert RandomIpfsNft__RangeOitOfBounds();
    }
